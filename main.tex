...
\section{\Large{\textbf{Programming Skills}}}
  ...
  \resumeSubHeadingListStart
    \item[]{
      \textbf{Languages}{: Python, C, Java, Javascript, PHP}
      \hfill
      \textbf{Technologies}{: Linux, Git, Make, SQL, Docker}
    }
    \item[]{
      \textbf{Web-Development}{: PHP, HTML, CSS, JavaScript, React, Django, Smarty}
    }

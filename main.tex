...
%===Compression system===%
  \resumeSubheading{LZW Encoder And Decoder}{\href{https://github.com/dbutler12/LZW-Encoding}{(link)}}{C, Linux}{LZW compression algorithm implementation}{}
    \resumeItemListStart
...
%===Bitmap Compression Tool===%
  \resumeSubheading{WAH and BBC Bitmap Compression}{\href{https://github.com/benjamineavenson/cs351_a4}{(link)}}{Python}{WAH and BBC compression algorithms implementation}{}
    \resumeItemListStart
...
%== ACM-W Club ==%
    ...
    {Vice President}{August 2019 - Present}
      \resumeItemListStart
        ...
        \resumeItem{Meeting leader}{Planned and instructed students on topics in security with practical examples}  
    \resumeItemListEnd

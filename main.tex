...
\section{\Large{\textbf{Programming Skills}}}
  ...
  \resumeSubHeadingListStart
    \item[]{
      \textbf{Languages}{: JavaScript, Python, Go, C, Java, PHP}
      \hfill
      \textbf{Technologies}{: Linux, Docker, Git, SQL, Make, Apache, Nginx}
    }
    \item[]{
      \textbf{Web-Development}{: React, Node.js, PHP, Django, HTML, CSS, Smarty}
    }
...
\section{\Large{\textbf{Relevant Experience}}}
  ...
  \resumeSubHeadingListStart
    ...
    {Full Stack Web Development Intern}{July 2017 - Present}
      \resumeItemListStart
...
%===p_scrape===%
  \resumeSubheading{pscrape}{\href{https://github.com/munikeraragon/p_scrape}{(link)}}{Django, AWS}{High Level Web Scraping Utility}{}
    \resumeItemListStart
      %TODO add technical details to bullet

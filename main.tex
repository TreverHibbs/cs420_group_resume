...
\section{\Large{\textbf{Relevant Experience}}}
  ...
  \resumeSubHeadingListStart
   ...
   {}{July 2020  - Present}
      ...
      \resumeItemListStart
      \resumeItem{}{Contributed to the research aimed at determining whether computer processes can be accurately classified as being "deadlocked".}
      \resumeItem{}{Extracted and manipulated the data of the computational processes, based on CPU usage. }
      \resumeItem{}{Constructed the machine learning model that consumed that data and outputted a classification prediction with a 95 percent accuracy}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
